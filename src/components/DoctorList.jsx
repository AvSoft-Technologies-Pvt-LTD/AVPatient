            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 disabled:bg-gray-100 disabled:text-gray-400"
                  onFocus={(e) => e.target.style.boxShadow = '0 0 0 2px #01D48C33'}
                  onBlur={(e) => e.target.style.boxShadow = 'none'}
                />
              </div>
